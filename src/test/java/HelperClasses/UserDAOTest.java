...
public class UserDAOTest {
	...
	public void getUserTest() {
		...
		try {
			...
			String query = "INSERT INTO " + Config.MYSQL_DATABASE_NAME + ".users (firstname,secondname,email,password,userrole) " + "VALUES('giorgi','baghdavadze','gbagh16@freeuni.edu.ge','giorgi121','student')";
