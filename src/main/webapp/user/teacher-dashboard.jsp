...
<head>
    ...
    <script>
        ...
        let contentForStudents = ['<div class="btn-group-vertical">',
            ...
            <div class="panel-heading">
                ...
                <div id="semReaderCol" class="panel-collapse collapse">
                    <table class="table" id="semReadersTable" style="width:100%">
                        ...
                        <tr>
                            <td><%=semReader.getFirstName()%>
                            </td>
                            <td><%=semReader.getLastName()%>
                            </td>
                            <td><%=semReader.getEmail()%>
                            </td>
                            <td>
                                <div>
            ...
            <div class="panel-heading">
                ...
                <div id="teacherAssCol" class="panel-collapse collapse">
                    <table class="table" id="teacherAssTable" style="width:100%">
                        ...
                        <tr>
                            <td><%=assistant.getFirstName()%>
                            </td>
                            <td><%=assistant.getLastName()%>
                            </td>
                            <td><%=assistant.getEmail()%>
                            </td>
                            <td>
                                <div>
                                    <a href="#" data-toggle="popover">
            ...
            <div class="panel-heading">
                ...
                <div id="studentsCol" class="panel-collapse collapse">
                    <table class="table" id="studentsTable" style="width:100%">
                        ...
                        <tr>
                            <td><%=student.getProfile().getName().getGivenName()%>
                            </td>
                            <td><%=student.getProfile().getName().getFamilyName()%>
                            </td>
                            <td><%=student.getProfile().getEmailAddress()%>
                            </td>
                            <td>
                                <div>
